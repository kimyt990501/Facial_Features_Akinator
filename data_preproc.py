...
info = pd.read_csv('C:\\Users\\user\\Desktop\\imgtest\\data\\player_info.csv', encoding='euc-kr', index_col=False)
info = info.drop(['Unnamed: 0'], axis=1)
#info.columns = ['name', 'birth']
#print(info)

samsung = pd.read_csv('C:\\Users\\user\\Desktop\\imgtest\\data\\samsung_face.csv', index_col=False)
...
result.to_csv('C:\\Users\\user\\Desktop\\imgtest\\data\\samsung_facialfeatures.csv', encoding='euc-kr', index=False)